...
The figures below present a breakdown of the above findings in percentages.
...
plot_data$ethnicity <- c("Black","White")
```
...
Any questions, comments, and/or feedback on any aspect of this report are greatly appreciated. Please contact Jolyon directly at jolyon.miles-wilson@blackthrive.org.

# Supporting information

The R code that produced this report is available on Github [here](https://github.com/JolyonJoseph/haringey_sms). A separate methodology paper that provides more detail on the data and analysis procedure is available [here](https://github.com/JolyonJoseph/sms_methodology).
